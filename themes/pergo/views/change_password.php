  ...
  <div class="lv-auth-page-inner">
    <div class="lv-auth-box">
      ...
      <div class="lv-auth-head">
        ...
        <div class="lv-auth-sub">Choose a strong new password for your account</div>
      </div>
      <form class="actionForm" action="<?=cn('auth/ajax_reset_password/'.$reset_key)?>" data-redirect="<?=cn('auth/login')?>" method="POST">
        <div class="lv-field">
          ...
          <div class="lv-field-icon">
            ...
            <input type="password" class="lv-input" name="password" placeholder="Min 6 characters" required autofocus>
          </div>
        </div>
        <div class="lv-field">
          ...
          <div class="lv-field-icon">
            <i class="fa fa-lock"></i>
            <input type="password" class="lv-input" name="re_password" placeholder="Repeat new password" required>
          </div>
        </div>
        <button type="submit" class="lv-btn-auth btn-submit">Update Password</button>
      </form>
